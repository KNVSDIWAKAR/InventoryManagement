...
import FavImg from '../assets/Banner-products/Favimage.jpg'
  ...
  return (
    <div className='px-4 lg:px-24 my-20  flex flex-col md:flex-row justify-between items-center gap-12'>
      <div className='md:w-1/2'>
        <img src={FavImg} alt='15' className='rounded md:w-9/12'/>
      </div>
      <div className='md:w-1/2 space-y-6'>
        ...
        <div className='flex flex-col sm:flex-row justify-between gap-6 md:w-3/4 my-14'>
            ...
            <br/>
            <Link to="/store" className='mt-8 block'><button className='bg-blue-700 text-white font-semibold px-5 py-2 rounded hover:bg-black transition-all duration-300'>Explore More</button></Link>
      </div>
    </div>
  )
}

export default FavGadget
